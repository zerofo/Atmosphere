...
dist: dist-no-debug
	...
	cd $(DIST_DIR); zip -r $(CURRENT_DIRECTORY)/out/atmosphere-$(ATMOSPHERE_VERSION)-debug.zip ./*; cd ../;
	#rm -rf $(DIST_DIR)
...
dist-no-debug: package3 $(CURRENT_DIRECTORY)/$(ATMOSPHERE_OUT_DIR)
	...
	cd $(DIST_DIR); zip -r $(CURRENT_DIRECTORY)/out/nintendo_nx_arm64_armv8a/release/atmosphere-$(ATMOSPHERE_VERSION).zip ./*; cd ../;
	#rm -rf $(DIST_DIR)
